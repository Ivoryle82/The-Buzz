...
/**
 * TodoItem is a custom HTML5 component (similar to app-root). Its style is declared in
 * todoitem.css, and its structure is declared in todoItem.html
 * 
 * TodoItem will be available to the application via the tag <todo-item>. Its has three
 * parts: a check box, a delete button, and a place where text can be displayed or edited.
 * 
...
export class TodoItem extends HTMLElement {
    ...
    static tagName = "todo-item"; /**idk y he didnt make it private but more on that later */
    ...
    /** That database id associated with this todo-item */
    #id;
    ...
    /**
     * Each time there is a todo-item tag in the HTML document, this constructor is called
     * it creates the associated HTML element
     * What is cool is that we already created the css for this element
     */
    constructor() {
        super();
        ...
        //Find the HTML elements that we will be manipulating and assign them to the variables
    ...
    /** Set up the listeners for various events of interest */
    connectedCallback() {
        // Set up listeners on the text box, the input box, the delete button, & check box
    ...
    /**
     * In response to a click on the display, switch to editing mode
     * 
     * @param e : the click event
     */
    #editContent(e) {
        e.stopPropagation(); //click is fully handled, dont propagate
    ...
    /**
     * In response to the edit box losing focus, update the model and reset the view
     */
    #saveContent() {
    ...
    /**
     * Handle clicks on the check box by toggling strikethrough and updating the model
     */
    #toggleCheck(e) {
        e.stopPropagation();
    ...
    /**
     * When delete button is pressed, update the model and remove the element
     */
    #deleteTodoItem(e) {
        e.stopPropagation();
