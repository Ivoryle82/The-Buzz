...
// mSelectAll = mConnection.prepareStatement("SELECT * FROM message ORDER BY PID
// DESC");
// mSelectOne = mConnection.prepareStatement("SELECT * FROM message WHERE
// PID=?");
// mUpdateOne = mConnection.prepareStatement("UPDATE message SET content = ?
// WHERE PID = ?");
// mInsertOne = mConnection.prepareStatement("INSERT INTO message VALUES
// (default, ?)");
